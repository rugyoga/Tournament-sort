...
class Tournament {
  ...
  public Object pop() {
    ...
    tourney = tourney instanceof Match ? ((Match)tourney).remove_winner(comparator) : null;
    return result;
  }
  ...
  static class Match {
    ...
    Match(Comparator<Object> comparator, Object a, Object b) {
      Object winner1 = winner(a);
      Object winner2 = winner(b);
      boolean result = comparator.compare(winner1, winner2) < 0;
      this.losers = result ? b : a;
      this.winners = result ? a : b;
      this.item = result ? winner1 : winner2;
    }
    ...
    public String toString() {
      return "([" + item + "]" + winners + losers + ")";
    }

    public Object remove_winner(Comparator<Object> comparator) {
      return winners instanceof Match
             ? new Match(comparator, losers, ((Match)winners).remove_winner(comparator))
             : losers;
    }
  }
  ...
  static void time(String description, Runnable action, InstrumentedCompare compare) {
    ...
    System.out.println(description + " took " + ((double)(finish - start) / 1000.0)
                       + " secs " + compare.count + " comparisons");
  }
